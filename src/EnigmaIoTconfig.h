...
#if defined(ENIGMA_MAX_INPUT_QUEUE_SIZE)
static const int MAX_INPUT_QUEUE_SIZE = ENIGMA_MAX_INPUT_QUEUE_SIZE; ///< @brief Input queue size for EnigmaIOT messages. Acts as a buffer to be able to handle messages during high load
#else
